    ...
    <footer className="bg-[#333333] text-white py-16">
      <div className="container mx-auto">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <h3 className="font-['Poppins',sans-serif] font-semibold text-lg mb-6 text-white">
              Quick Links
            </h3>
            <ul className="space-y-3">
              <li>
                <Link href="/">
                  <div className="text-white hover:text-[#C9A227] transition-colors cursor-pointer">
                    Home
                  </div>
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <a
                  href="mailto:info@ysarchitects.in"
                  className="text-white hover:text-gray-300"
                >
                  info@ysarchitects.in
                </a>
              </li>
              <li className="flex items-start">
                <span className="text-[#C9A227] mr-3">
